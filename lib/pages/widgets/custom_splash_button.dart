...
const Duration _kUnconfirmedRippleDuration = Duration(milliseconds: 0);
const Duration _kFadeInDuration = Duration(milliseconds: 0);
const Duration _kRadiusDuration = Duration(milliseconds: 225);
const Duration _kFadeOutDuration = Duration(milliseconds: 50);
const Duration _kCancelDuration = Duration(milliseconds: 0);
...
/// is used when the [Theme]'s [ThemeData.splashFactory] is [CustomSplashButton.splashFactory].
///
/// See also:
///
...
///    [Material].
class CustomSplashButton extends InteractiveInkFeature {
