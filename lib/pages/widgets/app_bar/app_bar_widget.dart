...
class AppBarWidget extends AppBar {
  AppBarWidget({
    ...
    //Function()? onTap,
    //Widget? actions, //should change to List<Widget>? if there is more than one widget.
    //Widget? leading
  }) : super(
          centerTitle: true,
          title: Text(title ?? '', textAlign: TextAlign.center, maxLines: 1, style: TextStyle(color: Colors.white),),
