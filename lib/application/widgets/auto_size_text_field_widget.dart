...
class AutoSizeTextFieldWidget extends StatefulWidget {
  ...
  /// Creates a [AutoSizeTextFieldWidget] widget.
  ///
  /// If the [style] argument is null, the text will use the style from the
  /// closest enclosing [DefaultTextStyle].
  const AutoSizeTextFieldWidget({
    Key? key,
    this.fullwidth = true,
    this.textFieldKey,
    this.style,
  ...
  @override
  _AutoSizeTextFieldWidgetState createState() => _AutoSizeTextFieldWidgetState();
}

class _AutoSizeTextFieldWidgetState extends State<AutoSizeTextFieldWidget> {
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(builder: (context, size) {
      ...
      if (style!.fontSize == null) {
        style = style.copyWith(fontSize: AutoSizeTextFieldWidget._defaultFontSize);
      }
      ...
      if (widget.overflowReplacement != null) {
